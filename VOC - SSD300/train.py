...
train_dataset = Mydataset(train_img_list, train_anno_list, phase="train", transform=Transform(input_size, color_mean),
                          anno_xml=AnnoXml(classes))
val_dataset = Mydataset(val_img_list, val_anno_list, phase="val", transform=Transform(input_size, color_mean),
                        anno_xml=AnnoXml(classes))
...
# MultiBoxLoss
# criterion cách gọi khác giống loss
                ...
                with torch.set_grad_enabled(phase == "train"):
                    ...
                    if phase == "train":
                        ...
                        nn.utils.clip_grad_value_(net.parameters(),
                                                  clip_value=2.0)  # parameter k lớn hơn 2.0 thì cắt đi
